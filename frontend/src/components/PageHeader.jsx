  ...
  return (
    <>
      <div className="flex flex-row gap-1">
        <h1 className="text-4xl font-bold text-gray-900">{titlePart1}</h1>
        <h1 className="text-4xl font-bold text-yellow-500">{titlePart2}</h1>
      </div>
      <p className="text-gray-600 italic py-2">{subtitle}</p>
    </>
  )
}
