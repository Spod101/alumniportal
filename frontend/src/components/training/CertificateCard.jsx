    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
      <div className="relative h-64 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-4 right-4 border-4 border-yellow-400 rounded-full w-16 h-16" />
        </div>
        ...
        <div className="absolute inset-4 border-2 border-yellow-400 rounded-lg pointer-events-none" />
      </div>
      <div className="p-4 bg-gray-50">
        ...
        <div className="flex justify-between items-center text-xs text-gray-600">
          <span>{certificate.issueDate} • {certificate.expiryDate}</span>
        </div>
