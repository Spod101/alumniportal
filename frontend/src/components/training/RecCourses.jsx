        ...
        <div className="px-6 sm:px-10 py-7">
          ...
          <div className="scale-[0.96] origin-center">
            <div className="relative">
              ...
              <div
                className="flex gap-4 justify-start overflow-x-auto scroll-smooth pb-4 snap-x snap-mandatory px-6 sm:px-8 [scroll-padding-left:1.5rem] sm:[scroll-padding-left:2rem] [scroll-padding-right:1.5rem] sm:[scroll-padding-right:2rem] [scrollbar-width:thin] [&::-webkit-scrollbar]:h-2 [&::-webkit-scrollbar-track]:bg-black/5 [&::-webkit-scrollbar-thumb]:bg-black/20 [&::-webkit-scrollbar-thumb]:rounded-full"
              >
                {courses.map((course, i) => (
                  <div
                    key={course.id}
                    className="shrink-0 snap-start !w-[280px] sm:!w-[260px] md:!w-[280px]"
                    style={{
