    ...
    <div className="px-10 py-8 bg-[#F5F5F5] min-h-screen">
      ...
      <div className="flex flex-col items-center gap-6 mb-14">
        <Card
          ...
          onClick={() => navigate('/feedback/alumni')}
        />
        <Card
        ...
        <Card
          ...
          onClick={() => navigate('/feedback/suggestions')}
        />
        <Card
          icon={<FiMessageSquare size={28} className="text-white" />}
          title="Recent Reviews"
          onClick={() => navigate('/feedback/reviews')}
        />
      </div>

      <div className="bg-white rounded-xl p-8 shadow-sm max-w-4xl mx-auto text-center">
...
function Card({ icon, title, onClick }) {
  return (
    <div
      onClick={onClick}
      className="bg-white rounded-xl p-6 flex items-center gap-4 shadow-sm cursor-pointer w-full max-w-2xl hover:bg-gray-50 transition"
    >
