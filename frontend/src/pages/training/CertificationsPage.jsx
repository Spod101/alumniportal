        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
          ...
          >
            ...
            <div className="text-left">
              <span className="block text-lg font-bold text-gray-800">{filteredCertificates.length} Certificates</span>
            ...
            {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
              <button
                ...
                className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                  currentPage === page ? 'bg-yellow-500 text-white' : 'border border-gray-300 text-gray-600 hover:bg-gray-50'
                }`}
              >
                {page}
              </button>
